...
/**
 * 使用 HttpClient 模拟发送（http/https）请求
 *
 * @author Lusifer
 * @version V1.0.0
 * @date 2017/9/27 20:42
 * @name HttpClientUtil
 */
