package com.zxj.itoken.common.utils.httpclient.common.util;

import com.zxj.itoken.common.utils.StringUtils;
import com.zxj.itoken.common.utils.httpclient.HttpClientUtil;
import com.zxj.itoken.common.utils.httpclient.builder.HCB;
import com.zxj.itoken.common.utils.httpclient.common.HttpConfig;
import com.zxj.itoken.common.utils.httpclient.common.HttpHeader;
import com.zxj.itoken.common.utils.httpclient.common.Utils;
import com.zxj.itoken.common.utils.httpclient.exception.HttpProcessException;
...
public class OCR {
	...
	private static final String apiKey = "1a8085d1b4e993649f2SvMv6S33ZzHfUb7OTVlT048KA9t0GcT1fSaumUsi9UYSb6kX6t3IlnbA";
	...
	public static String ocrCode(String imgFilePath, int limitCodeLen) {
		...
		try {
			...
			String[] results = StringUtils.regex("<Result>([^<]*)</Result>\\s*<Status>([^<]*)</Status>", html);
			String x = getResult(limitCodeLen, results);
			if (x != null) return x;
	 ...
	 * @return
	 */
	private static String getResult(int limitCodeLen, String[] results) {
		if (results.length > 0) {
